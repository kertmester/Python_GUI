...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        TouchButton(self, "Go to Settings",
                    lambda: controller.show_page(SettingsPage)).pack(pady=20)

        TouchButton(self, "Info Page",
                    lambda: controller.show_page(InfoPage)).pack(pady=20)
